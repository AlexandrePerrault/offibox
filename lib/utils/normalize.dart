...
String normalizeText(String input) {
  ...
  return input
      ...
      // NORMALISER s'écurisée → sécurisée : apostrophe ASCII + typographique (U+2019) et variantes
      ...
      // Infos dispensation biosimilaires : apostrophes parasites (m'édical, d'élivrée, n'écessaire, m'ême, m'édicament)
      .replaceAll(RegExp(r"m['\u2019\u02BC]\s*édical", caseSensitive: false), 'médical')
      .replaceAll(RegExp(r"m['\u2019\u02BC]\s*édicament", caseSensitive: false), 'médicament')
      .replaceAll(RegExp(r"d['\u2019\u02BC]\s*élivrée", caseSensitive: false), 'délivrée')
      .replaceAll(RegExp(r"d['\u2019\u02BC]\s*élivré\b", caseSensitive: false), 'délivré')
      .replaceAll(RegExp(r"n['\u2019\u02BC]\s*écessaire", caseSensitive: false), 'nécessaire')
      .replaceAll(RegExp(r"m['\u2019\u02BC]\s*ême\b", caseSensitive: false), 'même')
      .replaceAll("m'édical", 'médical')
      .replaceAll("m'édicament", 'médicament')
      .replaceAll("d'élivrée", 'délivrée')
      .replaceAll("d'élivré", 'délivré')
      .replaceAll("n'écessaire", 'nécessaire')
      .replaceAll("m'ême", 'même')
